...
- R^2 (full dataset) = 0.9950
- R^2 (Trained 80% of the dataset) = 0.9980
- R^2 (Tested 20% of the dataset) = 0.9830
- Prediction = 0 = Not Spam
...
- R^2 (Tested 20% of the dataset) = 0.9821
- Prediction = 0 = Not Spam
...
- Between logistic regression and the support vector classifier, logistic regression has the smaller difference (0.0091) and is therefore selected as the final model.
